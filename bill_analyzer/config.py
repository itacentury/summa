...
Wenn ich bei einem Einkauf Pfand zurückgebe, behandle dies als Negativzahl (z.B. '=2*(-0,15)' oder '=9*(-0,25)') und fasse jeden zurückgegebenen Pfand unter einem einzigen Eintrag 'Pfand' zusammen.
