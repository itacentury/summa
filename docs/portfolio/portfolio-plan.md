...
| `/api/portfolio/snapshot/new`   | GET    | prefill: active positions per depot, previous value each (plus `previous_carried`, flagging a previous reading that was itself carried forward), suggested next un-snapshotted week                                                                                                                                                                                 |
